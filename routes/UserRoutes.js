...
// ============================================================
// Helper — envoi via API HTTP Brevo (pas de SMTP, jamais bloqué)
// ============================================================
const sendBrevoEmail = async ({ to, subject, html }) => {
    const res = await fetch('https://api.brevo.com/v3/smtp/email', {
        ...
        body: JSON.stringify({
            sender: {
                name: process.env.SENDER_NAME || 'ShopMall',
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p>Votre mot de passe a été modifié avec succès.</p>
                            <p>Si vous n'êtes pas à l'origine de cette modification, veuillez contacter immédiatement notre support.</p>
                            <p>Cordialement,<br>L'équipe ${process.env.APP_NAME || 'ShopMall'}</p>
                        </div>
                    </div>
                </body>
                </html>
